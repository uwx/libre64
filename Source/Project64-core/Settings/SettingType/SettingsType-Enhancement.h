...
class CSettingTypeEnhancement :
    public CSettingType
{
public:
    CSettingTypeEnhancement(const char * PostFix);
    ~CSettingTypeEnhancement();
...
private:
    CSettingTypeEnhancement(void);                                   // Disable default constructor
    CSettingTypeEnhancement(const CSettingTypeEnhancement&);              // Disable copy constructor
    CSettingTypeEnhancement& operator=(const CSettingTypeEnhancement&);   // Disable assignment
};
